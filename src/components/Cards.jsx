const Cards = ({ name, cardNumber, month, year, CVC }) => {
  return (
    <section className="bg-main-mobile w-[375px] xl:bg-main-desktop h-[240px] mx-auto relative xl:h-full xl:float-left xl:ml-0 xl:max-w-[483px] xl:basis-[483px] ">
      <div
        id="cardBack"
        className="w-[300px] aspect-[1.83/1] absolute top-8 right-4 shadow-2xl xl:top-[360px] xl:right-0 xl:translate-x-1/2"
      >
        <img src="/public/images/bg-card-back.png" alt="Backside of Card" />
        <p
          id="cvc"
      ...
      >
        <img src="/public/images/card-logo.svg" alt="logo" className="absolute top-4 left-5 w-[60px] h-[33px]" />
        <img src="/public/images/bg-card-front.png" alt="Frontside of Card" />
        <p
          id="cardNumber"
